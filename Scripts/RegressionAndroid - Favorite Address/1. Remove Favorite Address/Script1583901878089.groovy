...
if (Mobile.verifyElementExist(findTestObject('Delivery Address - New/addrs_favadd_title_RUMAHMANTAN'), 2, FailureHandling.OPTIONAL) == 
false) {
    Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

    Mobile.callTestCase(findTestCase('Additional Cases/Add a Favorite Address'), [:], FailureHandling.STOP_ON_FAILURE)
} else {
    println = 'Favorite Address already Available'
}

Mobile.tap(findTestObject('Delivery Address - New/addrs_favadd1_favicon'), 1)
...
Mobile.verifyElementVisible(findTestObject('Delivery Address - New/addrs_favadd1_addrsdesc'), 1, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Delivery Address - New/addrs_favadd1_addrsdesc'), 1, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Delivery Address - New/addrs_favadd1_addrsdesc'), 1)
...
Mobile.verifyElementNotExist(findTestObject('Delivery Address - New/addrs_favadd_title_RUMAHMANTAN'), 1, FailureHandling.CONTINUE_ON_FAILURE)
