...
Mobile.verifyElementExist(findTestObject('Delivery Address/Current - Tebet Dalam Barat VIII/current_title_tebetdalamviii'), 
    1, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementAttributeValue(findTestObject('Delivery Address/Current - Tebet Dalam Barat VIII/current_favicon'), 
    'selected', 'false', 2, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Delivery Address/Current - Tebet Dalam Barat VIII/current_favicon'), 1)
...
Mobile.setText(findTestObject('Favorite Address/Save Fav Address/field_name'), 'Rumah Mantan', 1)
