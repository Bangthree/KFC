...
Mobile.callTestCase(findTestCase('Additional Cases/Log Out'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Additional Cases/Login Dana - User 6232'), [:], FailureHandling.STOP_ON_FAILURE)
...
if (Mobile.verifyElementExist(findTestObject('Voucher List page/vouchlist_vouch1_btnRedeem'), 2, FailureHandling.OPTIONAL) == 
false) {
    Mobile.pressBack()
...
Mobile.verifyElementExist(findTestObject('Voucher List page/Pop up Redeem Voucher/redvouch_btnConfirm'), 1, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Voucher List page/Pop up Redeem Voucher/redvouch_btnConfirm'), 1, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementAttributeValue(findTestObject('Voucher List page/Pop up Redeem Voucher/redvouch_btnConfirm'), 'enabled', 
    'true', 2)

Mobile.getText(findTestObject('Voucher List page/Pop up Redeem Voucher/redvouch_btnConfirm'), 1, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Voucher List page/Pop up Redeem Voucher/redvouch_btnCancel'), 1, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Voucher List page/vouchlist_vouch1_img'), 1, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementAttributeValue(findTestObject('Voucher Detail Page/vouchdet_btnConfirm'), 'enabled', 'true', 2)
