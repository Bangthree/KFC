...
Mobile.verifyElementExist(findTestObject('Home Screen/title_earnpay_bottombar'), 2, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Home Screen/title_earnpay_bottombar'), 2, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('Home Screen/title_earnpay_bottombar'), 'Earn & Pay', FailureHandling.CONTINUE_ON_FAILURE)
